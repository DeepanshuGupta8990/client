      ...
      <Grid container spacing={3} style={{ padding: 20 }}>
        ...
        <Grid item xs={12} sm={12} md={12}>
          <Paper style={{ padding: 20 }}>
            <Typography variant="h6">Historical Package Vulnerability Trends</Typography>
            <XLineChart 
              apiUrl={first.apiUrl} 
        ...
        <Grid item xs={12} sm={12} md={12}>
          <Paper style={{ padding: 20 }}>
            <Typography variant="h6">Exploit Growth Over Time</Typography>
            <XLineChart 
        ...
        <Grid item xs={12} sm={12} md={12}>
          <Paper style={{ padding: 20 }}>
            <Typography variant="h6">Historical Vulnerability Trends</Typography>
            {/* <XLineChart 
